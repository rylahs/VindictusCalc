...
function timecalc(num) {
    ...
    if (num == 1) {
        if (comptype == 'crit') {
            ...
            fullspecdmg = calcdmg(boss, 99999, 8100, 13930, 500, 999, 999, swordl, spearl)[1];
        } else if (comptype == 'nocrit') {
            dmg = document.querySelector('#calc1 input#nocritdmg').value * 1;
            fullspecdmg = calcdmg(boss, 99999, 8100, 13930, 500, 999, 999, swordl, spearl)[0];
        }
        ...
        if (comptype == 'crit') {
            ...
            fullspecdmg = calcdmg(boss, 99999, 8100, 13930, 5500, 999, 999, swordl, spearl)[1];
        } else if (comptype == 'nocrit') {
